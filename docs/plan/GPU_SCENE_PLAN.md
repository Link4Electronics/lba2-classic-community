...
Status: Phase 2 Implemented (interior room bricks, bodies and NZW polys behind `GpuScene`, default off). Phases 3–4 are still Proposed; [RENDERER.md](../RENDERER.md) remains the reference for what the engine does today.
