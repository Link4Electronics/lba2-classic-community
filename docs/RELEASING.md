...
| **Artifact naming** | `<exe>-<version>-<platform>-<arch>.<ext>`, e.g. `lba2cc-0.9.0-windows-x64.zip`, `lba2cc-0.9.0-AppImage-x86_64.AppImage`. |
...
| **Packaging logic** | Lives under `scripts/packaging/` (`make-appimage.sh`, `bundle-windows.sh`, future `bundle-macos.sh`). One script per platform; the workflow is glue. |
