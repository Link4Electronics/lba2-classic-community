...
| [GPU_RENDERER.md](GPU_RENDERER.md) | Hardware-accelerated render path: the behavior-owning common layer and the GL / SDL3-GPU backends behind a vtable, shared shaders, build flags and status. |
